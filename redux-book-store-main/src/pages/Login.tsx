      ...
      <div className="lg:flex">
        <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-24 rounded-md w-full max-w-md">
            ...
            <form onSubmit={onSubmit}>
              <div className="relative my-4">
                <input
                  ...
                  className="block px-2.5 pb-2.5 pt-4 w-full font-bold text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-zinc-800 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer border"
                  placeholder=" "
                />
                <label
              ...
              <div className="relative my-4 mb-6">
                <input
                  ...
                  className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-zinc-800 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer border "
                  placeholder=" "
                />
                <label
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="inline-flex cursor-pointer items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
